	...
	<div class="container">
    	<div class="row">
        	...
        	<div class="col-lg-7 col-sm-8 featured-work">
            	<h2>we pick players at random</h2>
            	<h3 class="padding-b">We use a computer generated random system to randomly select lottery players based on their <strong>email address</strong>.<br><br>Then we send them an email informing them of their selection and how much they stand to win if they apply.</h3><br>
